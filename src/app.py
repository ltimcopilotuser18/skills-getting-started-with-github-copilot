...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the school basketball team for practices and competitions",
    ...
    "Drama Club": {
        "description": "Learn acting, participate in school plays and theatrical performances",
